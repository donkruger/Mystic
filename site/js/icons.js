...
window.MYSTIC_ICONS = (function () {
  ...
  /* Potion flask — the spell mark. Smooth round bulb, tapered neck, flared
     rim, a liquid wave with rising bubbles, and a four-point sparkle. */
  var flask =
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' +
    '<circle cx="11.4" cy="15.3" r="6.1"/>' +
    '<path d="M9.6 4.4 V10.4"/>' +
    '<path d="M13.2 4.4 V10.4"/>' +
    '<path d="M8.2 4.2 H14.6"/>' +
    '<path d="M6.6 14.6 Q8.9 13.1 11.4 14.6 Q13.9 16.1 16.2 14.6"/>' +
    '<circle cx="9.7" cy="17.6" r="0.85" fill="currentColor" stroke="none"/>' +
    '<circle cx="13.2" cy="16.6" r="0.65" fill="currentColor" stroke="none"/>' +
    '<path d="M18.9 4.6 Q19.35 5.95 20.7 6.4 Q19.35 6.85 18.9 8.2 Q18.45 6.85 17.1 6.4 Q18.45 5.95 18.9 4.6 Z" fill="currentColor" stroke="none"/></svg>';
